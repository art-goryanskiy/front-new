  ...
  const paths = useMemo(
    () =>
      Array.from({ length: 36 }, (_, i) => ({
        ...
        width: 0.5 + i * 0.03,
        duration: 20 + ((i * 17 + (position + 1) * 31) % 11),
      })),
    [position]
  );
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center md:px-6">
        ...
        >
          ...
          <div className="group relative inline-block overflow-hidden rounded-2xl bg-linear-to-b from-black/10 to-white/10 p-px shadow-lg backdrop-blur-lg transition-shadow duration-300 hover:shadow-xl dark:from-white/10 dark:to-black/10">
            <Button
              variant="ghost"
