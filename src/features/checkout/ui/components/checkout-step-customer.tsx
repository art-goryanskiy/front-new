...
export interface CheckoutStepCustomerProps {
  ...
  setOrderLevelData: React.Dispatch<
    React.SetStateAction<OrderLevelData>
  >;
  organizationFromSuggest: OrganizationSuggestion | null;
  setOrganizationFromSuggest: React.Dispatch<
    React.SetStateAction<OrganizationSuggestion | null>
  >;
  organizationError: string | null;
  setOrganizationError: React.Dispatch<
    React.SetStateAction<string | null>
  >;
  showProfileSuggestion: boolean;
  individualData: IndividualApplicantData;
  setIndividualData: React.Dispatch<
    React.SetStateAction<IndividualApplicantData>
  >;
}

export const CheckoutStepCustomer = memo(
  function CheckoutStepCustomer({
    register,
    watch,
    setValue,
    customerType,
    isOrganization,
    isIndividualOrSelf,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars -- required by parent
    isSelf,
    organizations,
    orderLevelData,
    setOrderLevelData,
          ...
          {showProfileSuggestion && (
            <div className="rounded-xl border border-amber-500/40 bg-amber-500/10 px-4 py-3 text-sm">
              <p className="font-medium text-foreground">
                Чтобы данные подставлялись автоматически, заполните
                профиль.
              </p>
              <Button
                type="button"
                ...
                {organizationFromSuggest && (
                  <p className="text-sm text-muted-foreground">
                    ...
                    {organizationFromSuggest.inn &&
                      ` (ИНН ${organizationFromSuggest.inn})`}
                  </p>
                )}
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="очно-заочная">
                      Очно-заочная
                    </SelectItem>
                    <SelectItem value="заочная">Заочная</SelectItem>
                    <SelectItem value="дистанционная">
                      Дистанционная
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="крымскотатарский">
                      Крымскотатарский
                    </SelectItem>
                    <SelectItem value="украинский">
                      Украинский
                    </SelectItem>
                  </SelectContent>
                </Select>
