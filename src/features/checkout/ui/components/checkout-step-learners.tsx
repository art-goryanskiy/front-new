...
export interface CheckoutStepLearnersProps {
  ...
  setUseMyData: (key: string, learnerIndex: number, checked: boolean) => void;
  addLearnerToLine: (key: string, item: CartItemEntity) => Promise<void>;
  updatingCart: boolean;
  showLearnerStatusDots: boolean;
  learnerErrors: Record<string, LearnerFieldErrors[]>;
  setLearnerData: (key: string, learnerIndex: number, data: LearnerFormData) => void;
  isSelf: boolean;
  hasUserProfile: boolean;
}

export const CheckoutStepLearners = memo(function CheckoutStepLearners({
  items,
  lineKey,
  linesLearners,
  learnerSlotId,
                ...
                {learners.map((learner, idx) => {
                  ...
                  return (
                    <LearnerAccordionItem
                      ...
                      showUseMyDataCheckbox={!isSelf && hasUserProfile}
                      useMyData={useMyData}
