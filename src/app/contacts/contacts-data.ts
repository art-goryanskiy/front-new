...
export const CONTACT_DOCUMENTS: DocumentItem[] = [
  { title: "Свидетельство о государственной регистрации", href: "/certificate_registration.jpg" },
  ...
  { title: "Заключение о пожарной безопасности", href: "/fire_safety.jpg" },
  { title: "Санитарно-эпидемиологическое заключение", href: "/sanitary_conclusion.jpg" },
];
