...
export const SubcategoryListSkeleton = memo(function SubcategoryListSkeleton({
  backButton,
}: {
  ...
  return (
    <div className={SUBCATEGORY_LIST_CLASSES.container}>
      ...
      <div className={SUBCATEGORY_LIST_CLASSES.header}>
        <Skeleton variant="premium" className="mb-2 h-9 w-64 sm:h-10 sm:w-80" />
        <Skeleton variant="premium" className="h-6 w-full max-w-2xl" />
      </div>
      <div className={SUBCATEGORY_LIST_CLASSES.grid}>
        {Array.from({ length: 8 }, (_, i) => (
          ...
          >
            <Skeleton variant="premium" className="aspect-[16/10] w-full" />
