    ...
    >
      <Link
        ...
        className={cn(
          ...
          isFeatured &&
            "rounded-3xl border-border/50 shadow-xl dark:border-white/15"
        )}
      >
            ...
            {photoUrl && (
              <div
                className={cn(
                  ...
                  isWide
                    ? "h-36 w-full sm:h-auto sm:w-48"
                    : "h-36 w-full sm:h-auto sm:w-40"
                )}
              >
                {isOptimizableImageSrc(photoUrl) ? (
                  <Image
                  ...
                  <Image
                    ...
                    sizes="(max-width: 640px) 100vw, 160px"
                    unoptimized
                    className="h-full w-full object-cover object-top saturate-[0.88] transition-[transform,filter] duration-500 group-hover:scale-105 group-hover:saturate-100"
                  />
                )}
