...
export const EducationDocumentTable = memo(
  function EducationDocumentTable({
    searchQuery = "",
    onCountsChange,
  }: {
    searchQuery?: string;
    ...
    const { educationDocuments, loading, error } =
    ...
    useEffect(() => {
      onCountsChange?.({
        ...
        total: educationDocuments.length,
      });
          ...
          >
            <Table aria-label="Таблица документов об образовании">
              <TableHeader className={TABLE_CLASSES.thead}>
                <TableRow>
                  <TableHead
                    className={cn(TABLE_CLASSES.th, "w-14")}
                  ></TableHead>
                  <TableHead className={TABLE_CLASSES.th}>
                    Название
                  </TableHead>
                  <TableHead className={TABLE_CLASSES.th}>
                    Создан
                  ...
                  <TableHead
                    className={cn(TABLE_CLASSES.th, "w-24")}
                  ></TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
              ...
              <TableCaption className={TABLE_CLASSES.caption}>
                {filtered.length} из {educationDocuments.length}{" "}
                документов
              </TableCaption>
            </Table>
          </Surface>
