...
function getNotificationLink(entityType: string, entityId: string): string | null {
...
export const AdminNotificationsMenu = memo(function AdminNotificationsMenu({
  size = "md",
  ...
  const handleNotificationClick = useCallback(
    async (entityType: string, entityId: string, notificationId: string) => {
