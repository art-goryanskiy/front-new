...
export const TABLE_CLASSES = {
  ...
  th: "px-3 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground",
  ...
  card: "p-3 rounded-xl border border-border/40 bg-[var(--glass-card)]/80 backdrop-blur-sm hover:bg-[var(--glass-bg)]/80 transition-colors cursor-pointer",
