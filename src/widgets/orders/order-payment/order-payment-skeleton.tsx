...
export const OrderPaymentSkeleton = memo(function OrderPaymentSkeleton() {
  return (
      ...
      <Surface variant="floating" className="relative overflow-hidden p-6">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="flex gap-2 pt-2">
            <Skeleton variant="premium" className="h-10 w-32 rounded-xl" />
            <Skeleton variant="premium" className="h-10 w-24 rounded-xl" />
          </div>
        </div>
      </Surface>
      <Surface variant="floating" className="p-6">
        <div className="flex gap-2">
          <Skeleton variant="premium" className="h-10 flex-1 rounded-xl" />
          <Skeleton variant="premium" className="h-10 flex-1 rounded-xl" />
        </div>
        <div className="mt-6 space-y-4">
          <Skeleton variant="premium" className="h-24 w-full rounded-xl" />
