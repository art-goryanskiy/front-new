...
export type ChatFieldsFragment = { __typename?: 'Chat', id: string, userId: string, status: ChatStatus, assignedToId?: string | null, createdAt: any, updatedAt: any } & { ' $fragmentName'?: 'ChatFieldsFragment' };
