...
export type AdminChatCounts = {
  __typename?: 'AdminChatCounts';
  /** Закрытые чаты */
  closed: Scalars['Int']['output'];
  /** Открытые чаты */
  open: Scalars['Int']['output'];
  /** Открытые без назначенного админа */
  openUnassigned: Scalars['Int']['output'];
};
...
export type AdminMetrics = {
  ...
  /** Корзин с товарами (непустых) */
  cartsWithItems: Scalars['Int']['output'];
  /** Количество чатов по статусам */
  chatCounts: AdminChatCounts;
  /** Количество заказов по статусам */
  orderCounts: AdminOrderCounts;
  /** Всего заказов */
  ordersTotal: Scalars['Int']['output'];
  /** Сумма оплаченных заказов (выручка), руб. */
  revenuePaid: Scalars['Int']['output'];
  /** Новые пользователи за последние 30 дней */
  usersNewLast30Days: Scalars['Int']['output'];
  /** Всего пользователей (роль user) */
  usersTotal: Scalars['Int']['output'];
};

export type AdminOrderCounts = {
  __typename?: 'AdminOrderCounts';
  /** Ожидают оплаты */
...
export type AdminMetricsQuery = { __typename?: 'Query', adminMetrics: { __typename?: 'AdminMetrics', ordersTotal: number, revenuePaid: number, usersTotal: number, usersNewLast30Days: number, cartsWithItems: number, orderCounts: { __typename?: 'AdminOrderCounts', awaitingPayment: number, paid: number, inProgress: number, completed: number, cancelled: number }, chatCounts: { __typename?: 'AdminChatCounts', open: number, closed: number, openUnassigned: number } } };
