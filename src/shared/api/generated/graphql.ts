...
export type OrderFieldsFragment = { __typename?: 'Order', id: string, number?: string | null, userId: string, customerType: OrderCustomerType, organizationId?: string | null, contactEmail?: string | null, contactPhone?: string | null, status: OrderStatus, totalAmount: number, createdAt: any, updatedAt: any, lines: Array<{ __typename?: 'OrderLine', programId: string, programTitle: string, subProgramIndex?: number | null, subProgramTitle?: string | null, hours: number, price: number, quantity: number, lineAmount: number, learners: Array<{ __typename?: 'OrderLineLearner', lastName: string, firstName: string, middleName?: string | null, email?: string | null, phone?: string | null }> }> } & { ' $fragmentName'?: 'OrderFieldsFragment' };
