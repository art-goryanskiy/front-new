...
type Documents = {
    ...
    "\n  query AdminMetrics {\n    adminMetrics {\n      orderCounts {\n        awaitingPayment\n        paid\n        inProgress\n        completed\n        cancelled\n      }\n      ordersTotal\n      revenuePaid\n      usersTotal\n      usersNewLast30Days\n      chatCounts {\n        open\n        closed\n        openUnassigned\n      }\n      cartsWithItems\n    }\n  }\n": typeof types.AdminMetricsDocument,
...
const documents: Documents = {
    ...
    "\n  \n  mutation AdminUpdateOrderStatus(\n    $orderId: ID!\n    $status: OrderStatus!\n  ) {\n    adminUpdateOrderStatus(orderId: $orderId, status: $status) {\n      ...OrderFields\n    }\n  }\n": types.AdminUpdateOrderStatusDocument,
    "\n  mutation AdminDeleteOrder($orderId: ID!) {\n    adminDeleteOrder(orderId: $orderId)\n  }\n": types.AdminDeleteOrderDocument,
    "\n  mutation AdminUpdateOrderDocumentDate(\n    $input: AdminUpdateOrderDocumentDateInput!\n  ) {\n    adminUpdateOrderDocumentDate(input: $input) {\n      id\n      orderId\n      kind\n      fileUrl\n      documentDate\n      createdAt\n      updatedAt\n    }\n  }\n": types.AdminUpdateOrderDocumentDateDocument,
    "\n  mutation AdminGenerateOrderContract(\n    $input: AdminGenerateOrderDocumentInput!\n  ) {\n    adminGenerateOrderContract(input: $input) {\n      id\n      orderId\n      kind\n      fileUrl\n      documentDate\n      createdAt\n      updatedAt\n    }\n  }\n": types.AdminGenerateOrderContractDocument,
    "\n  mutation AdminGenerateOrderAct(\n    $input: AdminGenerateOrderDocumentInput!\n  ) {\n    adminGenerateOrderAct(input: $input) {\n      id\n      orderId\n      kind\n      fileUrl\n      documentDate\n      createdAt\n      updatedAt\n    }\n  }\n": types.AdminGenerateOrderActDocument,
    "\n  mutation AdminGenerateOrderTrainingApplication($orderId: ID!) {\n    adminGenerateOrderTrainingApplication(orderId: $orderId) {\n      id\n      orderId\n      kind\n      fileUrl\n      documentDate\n      createdAt\n      updatedAt\n    }\n  }\n": types.AdminGenerateOrderTrainingApplicationDocument,
    "\n  \n  mutation AdminSetOrderTrainingDates(\n    $orderId: ID!\n    $input: AdminSetOrderTrainingDatesInput!\n  ) {\n    adminSetOrderTrainingDates(orderId: $orderId, input: $input) {\n      ...OrderFields\n    }\n  }\n": types.AdminSetOrderTrainingDatesDocument,
    ...
    "\n  query AdminMetrics {\n    adminMetrics {\n      orderCounts {\n        awaitingPayment\n        paid\n        inProgress\n        completed\n        cancelled\n      }\n      ordersTotal\n      revenuePaid\n      usersTotal\n      usersNewLast30Days\n      chatCounts {\n        open\n        closed\n        openUnassigned\n      }\n      cartsWithItems\n    }\n  }\n": types.AdminMetricsDocument,
    "\n  fragment OrderFields on Order {\n    id\n    number\n    userId\n    customerType\n    customerDisplayName\n    organizationId\n    contactEmail\n    contactPhone\n    status\n    totalAmount\n    createdAt\n    updatedAt\n    statusChangedAt\n    trainingStartDate\n    trainingEndDate\n    trainingForm\n    trainingLanguage\n    headPosition\n    headFullName\n    contactPersonName\n    contactPersonPosition\n    lines {\n      programId\n      programTitle\n      subProgramIndex\n      subProgramTitle\n      hours\n      price\n      quantity\n      lineAmount\n      learners {\n        lastName\n        firstName\n        middleName\n        email\n        phone\n        dateOfBirth\n        citizenship\n        passportSeries\n        passportNumber\n        passportIssuedBy\n        passportIssuedAt\n        passportDepartmentCode\n        snils\n        educationQualification\n        educationDocumentIssuedAt\n        passportRegistrationAddress\n        residentialAddress\n        workPlaceName\n        position\n      }\n    }\n  }\n": types.OrderFieldsFragmentDoc,
    "\n  \n  query MyOrders($filter: MyOrdersFilterInput) {\n    myOrders(filter: $filter) {\n      ...OrderFields\n    }\n  }\n": types.MyOrdersDocument,
    "\n  \n  query Order($id: ID!) {\n    order(id: $id) {\n      ...OrderFields\n    }\n  }\n": types.OrderDocument,
    "\n  query OrderInvoiceStatus($orderId: ID!) {\n    orderInvoiceStatus(orderId: $orderId) {\n      status\n    }\n  }\n": types.OrderInvoiceStatusDocument,
    "\n  query OrderPaymentSync($orderId: ID!) {\n    orderPaymentSync(orderId: $orderId) {\n      status\n      updated\n      payments {\n        paymentId\n        status\n      }\n    }\n  }\n": types.OrderPaymentSyncDocument,
    "\n  query OrderDocuments($orderId: ID!) {\n    orderDocuments(orderId: $orderId) {\n      id\n      orderId\n      kind\n      fileUrl\n      documentDate\n      createdAt\n      updatedAt\n    }\n  }\n": types.OrderDocumentsDocument,
    "\n  \n  query AdminOrders($filter: AdminOrdersFilterInput) {\n    adminOrders(filter: $filter) {\n      ...OrderFields\n    }\n  }\n": types.AdminOrdersDocument,
    "\n  \n  query AdminOrder($id: ID!) {\n    adminOrder(id: $id) {\n      ...OrderFields\n    }\n  }\n": types.AdminOrderDocument,
    "\n  query AdminOrderDocuments($orderId: ID!) {\n    adminOrderDocuments(orderId: $orderId) {\n      id\n      orderId\n      kind\n      fileUrl\n      documentDate\n      createdAt\n      updatedAt\n    }\n  }\n": types.AdminOrderDocumentsDocument,
